package inc.blubz.fitsync.model.webservice
...
class WebServiceModule {
    ...
    fun provideKtorHttpClient(application: Application): HttpClient {
        return HttpClient(OkHttp.create()) {
            ...
            defaultRequest {
                url("https://raw.githubusercontent.com/jeffdcamp/android-fitsync/33017aa38f59b3ff728a26c1ee350e58c8bb9647/src/test/")
...
//            install(HttpCache) // Talk about cache
    ...
    companion object {
        ...
        private val USER_AGENT: String = inc.blubz.fitsync.BuildConfig.USER_AGENT_APP_NAME + " " + inc.blubz.fitsync.BuildConfig.VERSION_NAME + " / " + "Android " + Build.VERSION.RELEASE + " " +
