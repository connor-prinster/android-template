package inc.blubz.fitsync.model.webservice.colors
...
@Inject constructor(
    ...
    suspend fun getColorsByFullUrl(): ApiResponse<ColorsDto, Unit> {
        return httpClient.executeSafely(
            { get("https://raw.githubusercontent.com/jeffdcamp/android-fitsync/33017aa38f59b3ff728a26c1ee350e58c8bb9647/src/test/json/rest-test.json") }
        ) {
            it.body()
        }
    }
