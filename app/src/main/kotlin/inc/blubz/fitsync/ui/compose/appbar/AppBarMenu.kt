package inc.blubz.fitsync.ui.compose.appbar
...
sealed interface AppBarMenuItem {
    ...
    ) : AppBarMenuItem, inc.blubz.fitsync.ui.compose.menu.OverflowMenuItem.MenuItem(text, leadingIcon, trailingIcon, action) {
    ...
    class OverflowMenuItemCustom(
        ...
        override val action: () -> Unit
    ) : AppBarMenuItem, inc.blubz.fitsync.ui.compose.menu.OverflowMenuItem.MenuItemCustom(text, leadingContent, trailingContent, action) {
    ...
    object OverflowDivider : AppBarMenuItem, inc.blubz.fitsync.ui.compose.menu.OverflowMenuItem.Divider()
