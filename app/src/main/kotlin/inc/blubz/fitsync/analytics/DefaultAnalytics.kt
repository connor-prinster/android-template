package inc.blubz.fitsync.analytics
...
class DefaultAnalytics(
    ...
    init {
        ...
        // Set log levels
        AppAnalytics.setLogLevel(if (inc.blubz.fitsync.BuildConfig.DEBUG) AppAnalytics.LogLevel.VERBOSE else AppAnalytics.LogLevel.UPLOAD)
